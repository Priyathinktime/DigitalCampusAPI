...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/PanelMembers.feature",
        ...
        , monochrome = true,
        tags = " @PanelMembersTest "
)

public class PanelMembersTestRunner extends AbstractTestNGCucumberTests {
    @Override
