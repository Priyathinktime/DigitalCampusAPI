...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/EvaluationProcess.feature",
        ...
        , monochrome = true,
        tags = " @EvaluationProcessTest "
)

public class EvaluationProcessTestRunner extends AbstractTestNGCucumberTests {
    @Override
