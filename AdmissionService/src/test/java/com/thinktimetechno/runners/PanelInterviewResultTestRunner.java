...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/PanelInterviewResult.feature",
       ...
       , monochrome = true,
        tags = " @PanelInterviewResultTest "
)

public class PanelInterviewResultTestRunner extends AbstractTestNGCucumberTests {
    @Override
