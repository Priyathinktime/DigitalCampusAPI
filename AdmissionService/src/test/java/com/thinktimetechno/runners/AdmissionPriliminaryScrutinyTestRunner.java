...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/AdmissionPriliminaryScrutiny.feature",
        ...
        , monochrome = true,
        tags = " @AdmissionPriliminaryScrutinyTest "
)

public class AdmissionPriliminaryScrutinyTestRunner extends AbstractTestNGCucumberTests {
    @Override
