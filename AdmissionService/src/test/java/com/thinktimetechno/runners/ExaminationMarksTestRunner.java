...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/ExaminationMarks.feature",
        ...
        , monochrome = true,
        tags = "  @ExaminationMarksTest "
)

public class ExaminationMarksTestRunner extends AbstractTestNGCucumberTests {
    @Override
