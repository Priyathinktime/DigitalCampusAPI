...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/ChangeStudentDetails.feature",
        ...
        , monochrome = true,
        tags = "  @ChangeStudentDetailsTest "
)

public class ChangeStudentDetailsTestRunner extends AbstractTestNGCucumberTests {
    @Override
