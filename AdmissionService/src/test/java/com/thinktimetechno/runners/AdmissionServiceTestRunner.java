...
@Test
@CucumberOptions(
        features =  "src/test/resources/features/AdmissionServiceFeatures",
        ...
        , monochrome = true,
        tags = " @AdmissionSaleTest "
)

public class AdmissionServiceTestRunner extends AbstractTestNGCucumberTests {
    @Override
