...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/ExamSubjects.feature",
        ...
        , monochrome = true,
        tags = "  @ExamSubjectsTest "
)

public class ExamSubjectsTestRunner extends AbstractTestNGCucumberTests {
    @Override
