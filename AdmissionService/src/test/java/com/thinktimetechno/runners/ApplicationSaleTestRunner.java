...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/ApplicationSale.feature",
        ...
        , monochrome = true,
        tags = " @ApplicationSaleTest "
)

public class ApplicationSaleTestRunner extends AbstractTestNGCucumberTests {
    @Override
