...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/ExamSchedule.feature",
        ...
        , monochrome = true,
        tags = " @ExamScheduleTest "
)

public class ExamScheduleTestRunner extends AbstractTestNGCucumberTests {
    @Override
