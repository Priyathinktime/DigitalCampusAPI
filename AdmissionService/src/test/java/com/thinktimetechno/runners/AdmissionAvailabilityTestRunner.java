...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/AdmissionAvailability.feature",
        ...
        , monochrome = true,
        tags = " @AdmissionAvailabilityTest "
)

public class AdmissionAvailabilityTestRunner extends AbstractTestNGCucumberTests {
    @Override
