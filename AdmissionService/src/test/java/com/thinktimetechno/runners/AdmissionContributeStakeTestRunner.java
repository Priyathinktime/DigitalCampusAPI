...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/AdmissionContributeStake.feature",
        ...
        , monochrome = true,
        tags = "  @AdmissionContributeStakeTest "
)

public class AdmissionContributeStakeTestRunner extends AbstractTestNGCucumberTests {
    @Override
