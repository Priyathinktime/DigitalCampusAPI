...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/ObservationAndInterviewReport.feature",
        ...
        , monochrome = true,
        tags = " @ObservationAndInterviewReportTest "
)

public class ObservationAndInterviewReportTestRunner extends AbstractTestNGCucumberTests {
    @Override
