...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/AdmissionCategory.feature",
        ...
        , monochrome = true,
        tags = " @AdmissionCategoryTest "
)

public class AdmissionCategoryTestRunner extends AbstractTestNGCucumberTests {
    @Override
