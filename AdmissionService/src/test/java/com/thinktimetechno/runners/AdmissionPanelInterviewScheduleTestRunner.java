...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/AdmissionPanelInterviewSchedule.feature",
        ...
        , monochrome = true,
        tags = " @AdmissionPanelInterviewScheduleTest "
)

public class AdmissionPanelInterviewScheduleTestRunner extends AbstractTestNGCucumberTests {
    @Override
