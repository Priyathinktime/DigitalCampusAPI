...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/ProposedAdmissions.feature",
        ...
        , monochrome = true,
        tags = "  @ProposedAdmissionsTest "
)

public class ProposedAdmissionsTestRunner extends AbstractTestNGCucumberTests {
    @Override
