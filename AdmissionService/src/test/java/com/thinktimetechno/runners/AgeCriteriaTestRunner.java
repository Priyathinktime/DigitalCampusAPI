...
@Test
@CucumberOptions(
        features = "src/test/resources/features/AdmissionServiceFeatures/AgeCriteria.feature",
        ...
        , monochrome = true,
        tags = " @AgeCriteriaTest "
)

public class AgeCriteriaTestRunner extends AbstractTestNGCucumberTests {
    @Override
